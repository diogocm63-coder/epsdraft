...
export const gerarAtividadesDetalhe = (): AtividadeDetalheData[] => [
  ...
  {
    atividade: "Tratamento Fitossanitário",
    janeiro: 0,
    fevereiro: 0,
    marco: 0,
    abril: 0,
  ...
  {
    atividade: "Aplicação de Herbicidas",
    janeiro: 0,
    fevereiro: 0,
    marco: 50,
    abril: 100,

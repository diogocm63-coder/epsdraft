...
const aiAlerts = [{
  ...
  desc: "Produção de Cabernet pode ficar 12% abaixo no Q4..."
}, {
  type: "trend",
  title: "Aumento de Procura",
  desc: "Vinhos premium com aumento de 23% no mercado..."
}, {
  type: "optimize",
  title: "Otimização",
  desc: "Eficiência da linha de engarrafamento pode melhorar 8%..."
}];
...
const harvestPredictionData = [{
  ...
  name: "Deficiência de Inventário",
  green: 45,
  yellow: 35,
  red: 20
}, {
...
const ProducaoProcuraPage = () => {
  return <div className="flex h-screen bg-[#f8f8f8] overflow-hidden">
      <DashboardSidebar />
            ...
            <div className="col-span-2 space-y-2">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3">
                ...
                <div className="space-y-2">
                  {aiAlerts.map((alert, i) => <div key={i} className="flex items-start gap-2 p-2 bg-gray-50 rounded">
                ...
                <div className="flex-1 min-h-0">
                  <ResponsiveContainer width="100%" height="100%">
                    <ComposedChart data={wineSalesData}>
                      ...
                      <Line type="monotone" dataKey="general" stroke="#4ECDC4" strokeWidth={2} dot={{
                      r: 3
                    }} />
                      <Line type="monotone" dataKey="cabernet" stroke="#C9A227" strokeWidth={2} dot={{
                      r: 3
                    }} />
                    </ComposedChart>
                  </ResponsiveContainer>
            ...
            <div className="col-span-4 space-y-2">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3">
                ...
                <div className="space-y-1.5 mb-3">
                  <div>
                    ...
                    <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                      <div className="h-full bg-[#4ECDC4] rounded-full" style={{
                      width: "85%"
                    }}></div>
                    </div>
                  </div>
                ...
                <div className="space-y-1">
                  {harvestPredictionData.map((item, i) => <div key={i} className="flex items-center gap-2">
                      <span className="text-[8px] text-gray-600 w-28 truncate">{item.name}</span>
                      <div className="flex-1 flex h-3 rounded overflow-hidden">
                        <div className="bg-[#4ECDC4]" style={{
                      width: `${item.green}%`
                    }}></div>
                        <div className="bg-[#C9A227]" style={{
                      width: `${item.yellow}%`
                    }}></div>
                        <div className="bg-[#8B1538]" style={{
                      width: `${item.red}%`
                    }}></div>
                      </div>
                    </div>)}
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3">
                ...
                <ResponsiveContainer width="100%" height={140}>
                  <LineChart data={forecastAccuracyData}>
                    ...
                    <Tooltip />
                    <Line type="monotone" dataKey="demand" stroke="#4ECDC4" strokeWidth={2} dot={{
                    r: 2
                  }} />
                    <Line type="monotone" dataKey="marketDemand" stroke="#C9A227" strokeWidth={2} dot={{
                    r: 2
                  }} />
                  </LineChart>
                </ResponsiveContainer>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3">
                ...
                <div className="overflow-auto max-h-[140px]">
                  <table className="w-full text-[9px]">
                    ...
                    <tbody>
                      {productionPlanningData.map((row, idx) => <tr key={idx} className="border-b border-gray-100">
                          ...
                          <td className="py-1">
                            {row.q1 > 0 && <div className="w-full h-2 bg-[#4ECDC4] rounded" style={{
                          width: `${row.q1}%`
                        }}></div>}
                            {row.q1 === 0 && <span className="text-gray-400">0</span>}
                          </td>
                          <td className="py-1">
                            {row.q2 > 0 && <div className="w-full h-2 bg-[#C9A227] rounded" style={{
                          width: `${row.q2}%`
                        }}></div>}
                            {row.q2 === 0 && <span className="text-gray-400">0</span>}
                          </td>
                          <td className="py-1">
                            {row.q3 > 0 && <div className="w-full h-2 bg-[#C9A227] rounded" style={{
                          width: `${row.q3}%`
                        }}></div>}
                            {row.q3 === 0 && <span className="text-gray-400">0</span>}
                          </td>
                          <td className="py-1">
                            {row.q4 > 0 && <div className="w-full h-2 bg-[#8B1538] rounded" style={{
                          width: `${row.q4}%`
                        }}></div>}

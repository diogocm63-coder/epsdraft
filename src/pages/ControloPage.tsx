      ...
      <div className="space-y-4 h-[calc(100vh-100px)] overflow-auto">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            ...
            <ResponsiveContainer width="100%" height={200}>
              <LineChart data={eficienciaData}>
                ...
                <Tooltip />
                <Line type="monotone" dataKey="eficiencia" stroke="#8B1538" strokeWidth={2} dot={{
                fill: "#8B1538",
                r: 4
              }} />
                <Line type="monotone" dataKey="potencial" stroke="#C9A227" strokeWidth={2} dot={{
                fill: "#C9A227",
                r: 4
              }} />
              </LineChart>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            ...
            <ResponsiveContainer width="100%" height={200}>
              <PieChart>
                <Pie data={expansaoData} cx="50%" cy="50%" innerRadius={50} outerRadius={80} paddingAngle={2} dataKey="value" label={({
                name,
                value
              }) => `${name}: ${value}%`} labelLine={false}>
                  {expansaoData.map((entry, index) => <Cell key={`cell-${index}`} fill={entry.color} />)}
                </Pie>
                <Tooltip />
              </PieChart>
            </ResponsiveContainer>

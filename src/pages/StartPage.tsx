...
const StartPage = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-eps-background via-white to-eps-background flex flex-col items-center justify-center p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 max-w-7xl w-full px-4">
        ...
        return <button key={module.id} onClick={() => navigate(module.path)} className="group bg-white hover:bg-white border border-gray-100 rounded-xl p-6 transition-all duration-300 hover:shadow-xl flex flex-col items-center text-center min-h-[200px]">

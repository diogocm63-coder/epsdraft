      ...
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 rounded-full bg-eps-primary/10 flex items-center justify-center mx-auto mb-4">
            <Package className="w-8 h-8 text-eps-primary" />
          </div>
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Stocks Iniciais</h1>
          <p className="text-gray-500">Gestão de stocks iniciais para planeamento</p>
        </div>
      </div>
    </DecisaoLayout>
  );

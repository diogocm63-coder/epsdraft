...
const producaoData = [
  { talhao: "Talhão 1", produto: "Vinho", variedade: "Castelão", areaHa: 12.5, producaoEsperadaKg: 87500, producaoEsperadaKgHa: 7000, custoTotal: 45000, custoAtual: 38000 },
  { talhao: "Talhão 2", produto: "Vinho", variedade: "Fernão Pires", areaHa: 8.3, producaoEsperadaKg: 58100, producaoEsperadaKgHa: 7000, custoTotal: 32000, custoAtual: 28500 },
  { talhao: "Talhão 3", produto: "Vinho", variedade: "Touriga Nacional", areaHa: 15.2, producaoEsperadaKg: 91200, producaoEsperadaKgHa: 6000, custoTotal: 58000, custoAtual: 52000 },
  { talhao: "Talhão 4", produto: "Vinho", variedade: "Arinto", areaHa: 6.8, producaoEsperadaKg: 47600, producaoEsperadaKgHa: 7000, custoTotal: 28000, custoAtual: 24000 },
  { talhao: "Talhão 5", produto: "Pera", variedade: "Rocha", areaHa: 10.0, producaoEsperadaKg: 250000, producaoEsperadaKgHa: 25000, custoTotal: 65000, custoAtual: 58000 },
  { talhao: "Talhão 6", produto: "Pera", variedade: "Rocha", areaHa: 7.5, producaoEsperadaKg: 187500, producaoEsperadaKgHa: 25000, custoTotal: 48000, custoAtual: 42000 },
  { talhao: "Talhão 7", produto: "Vinho", variedade: "Trincadeira", areaHa: 9.4, producaoEsperadaKg: 56400, producaoEsperadaKgHa: 6000, custoTotal: 38000, custoAtual: 35000 },
  { talhao: "Talhão 8", produto: "Pera", variedade: "Passe Crassane", areaHa: 5.2, producaoEsperadaKg: 114400, producaoEsperadaKgHa: 22000, custoTotal: 32000, custoAtual: 28000 },
];
...
const calcularMetricas = (item: typeof producaoData[0]) => {
  ...
  return { ...item, custoKgPrevisto, custoKgAtual, custoHaPrevisto, custoHaAtual };
};
              ...
              {dadosComMetricas.map((item, index) => (
                <TableRow key={index} className="hover:bg-muted/30">
                  ...
                  <TableCell className="text-xs">
                    <Badge 
                      variant="outline" 
                      className={item.produto === "Vinho" ? "bg-eps-primary/10 text-eps-primary border-eps-primary/30" : "bg-eps-gold/10 text-eps-gold border-eps-gold/30"}
                    >
                      {item.produto}
                    </Badge>
                  </TableCell>

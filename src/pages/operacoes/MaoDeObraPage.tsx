...
const MaoDeObraPage = () => {
  ...
  return (
    <OperacoesLayout title="Mão de Obra">
      <div className="flex flex-col h-full gap-2">
        <OperacoesSummary />
        
        <div className="flex items-center justify-between border-b border-gray-200 pb-1">
          <h2 className="text-eps-primary font-bold text-sm tracking-[0.3em]">L A B O R A Ç Ã O</h2>
        </div>

        <div className="grid grid-cols-2 gap-3 flex-1 min-h-0">
          {/* Total de Horas Trabalhadas */}
          <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
            <h3 className="text-eps-primary font-semibold text-xs mb-2">Total de Horas Trabalhadas</h3>
          ...
          <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
            <h3 className="text-eps-primary font-semibold text-xs mb-2">Horas Trabalhadas por Dia da Semana</h3>
            <div className="flex-1 min-h-0">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
            <h3 className="text-eps-primary font-semibold text-xs mb-2">Horas Trabalhadas por Atividade</h3>
            <div className="flex-1 min-h-0">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
            <div className="flex justify-between items-start mb-2">
              <h3 className="text-eps-primary font-semibold text-xs">Total de Horas por ha</h3>

    ...
    <OperacoesLayout title="D E S E M P E N H O">
      <div className="grid grid-cols-2 gap-3 h-full">
        ...
        <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
          <h3 className="text-[#8B1538] font-semibold text-xs mb-2">Horas Trabalhadas/ha</h3>
        ...
        <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
          <h3 className="text-[#8B1538] font-semibold text-xs mb-2">Horas Trabalhadas/ha por Tipo de Atividade</h3>
          <div className="flex-1 min-h-0">
            <ResponsiveContainer width="100%" height="100%">
        ...
        {/* Custo/ha */}
        <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
          <h3 className="text-[#8B1538] font-semibold text-xs mb-2">Custo/ha</h3>
          <div className="flex-1 min-h-0">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
          <h3 className="text-[#8B1538] font-semibold text-xs mb-1">Custo/ha por Tipo de Atividade</h3>
          <div className="flex items-center gap-3 mb-1 text-[9px]">
            <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-[#8B1538]" /> Custo Produtos/ha</div>
            <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-[#C4A962]" /> Custo Trabalhadores/ha</div>
          </div>
          <div className="flex-1 min-h-0">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={custoHaPorAtividade} margin={{ top: 25, right: 20, left: 20, bottom: 20 }}>
                ...
                <Bar dataKey="custoTrabalhadores" fill="#C4A962" barSize={30} radius={[2, 2, 0, 0]}>

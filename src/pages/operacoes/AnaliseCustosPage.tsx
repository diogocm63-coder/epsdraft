    ...
    <OperacoesLayout title="C U S T O">
      <div className="grid grid-cols-2 gap-3 h-full">
        ...
        <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
          <h3 className="text-[#8B1538] font-semibold text-xs mb-2">Custo Total</h3>
        ...
        <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
          <h3 className="text-[#8B1538] font-semibold text-xs mb-2">Top 5 Atividades Maior Custo</h3>
          <div className="flex-1 min-h-0">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
          <h3 className="text-[#8B1538] font-semibold text-xs mb-2">Custo Total por Produto</h3>
          <div className="flex-1 min-h-0">
            <ResponsiveContainer width="100%" height="100%">
        ...
        {/* Custo Total por ha */}
        <div className="bg-white border border-gray-200 p-3 flex flex-col min-h-0">
          <h3 className="text-[#8B1538] font-semibold text-xs mb-2">Custo Total por ha</h3>
          <div className="flex-1 min-h-0">
            <ResponsiveContainer width="100%" height="100%">

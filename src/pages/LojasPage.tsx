          ...
          <div className="grid grid-cols-12 gap-2 h-full">
            ...
            <div className="col-span-2 flex flex-col gap-2 h-full">
              ...
              <div className="bg-card rounded-xl border p-2 flex-1 flex flex-col min-h-0">
                <h3 className="text-[11px] font-semibold text-foreground mb-1">Inventário por Tipo</h3>
            ...
            <div className="col-span-6 flex flex-col gap-2 h-full">
              ...
              <div className="bg-card rounded-xl border p-2 flex-1 flex flex-col min-h-0 overflow-hidden">
                <h3 className="text-[11px] font-semibold text-foreground mb-1">Clientes</h3>
            ...
            <div className="col-span-4 flex flex-col gap-2 h-full">
              ...
              <div className="bg-card rounded-xl border p-2 flex-1 flex flex-col min-h-0">
                <h3 className="text-[11px] font-semibold text-foreground mb-1">Inventário por Produto</h3>
              ...
              {/* Resumo por Cliente */}
              <div className="bg-card rounded-xl border p-2 flex-1 flex flex-col min-h-0">
                <h3 className="text-[11px] font-semibold text-foreground mb-1">Resumo por Cliente</h3>
                <ScrollArea className="flex-1">
                      ...
                      return (
                        <div key={idx} className="bg-muted/30 rounded p-1.5">
                          <div className="flex justify-between items-center">
                            <span className="font-medium text-[11px] text-foreground">{cliente.nome.substring(0, 18)}</span>
                          ...
                          <div className="grid grid-cols-3 gap-1 text-center mt-1">
                            <div>
                              ...
                              <div className="font-semibold text-[11px] text-primary">{reservas.toLocaleString()}</div>
                            </div>
                            <div>
                              <div className="text-[9px] text-muted-foreground">Vendas</div>
                              <div className="font-semibold text-[11px] text-secondary">{vendas.toLocaleString()}</div>
                            </div>
                            <div>
                              <div className="text-[9px] text-muted-foreground">Taxa</div>
                              <div className="font-semibold text-[11px] text-foreground">{Math.floor((vendas / reservas) * 100)}%</div>
                            </div>
                          </div>
                        </div>
                      );
              ...
              {/* Resumo de Conversão */}
              <div className="bg-card rounded-xl border p-2 flex-1 flex flex-col min-h-0">
                <h3 className="text-[11px] font-semibold text-foreground mb-1">Resumo de Conversão</h3>
                <div className="flex-1 flex items-center">
                  <div className="grid grid-cols-3 gap-1.5 w-full">
                    <div className="text-center p-1.5 bg-muted/30 rounded">
                      <div className="text-[13px] font-bold text-primary">{totalReservas.toLocaleString()}</div>
                      <div className="text-[9px] text-muted-foreground">Reservas</div>
                    </div>
                    <div className="text-center p-1.5 bg-muted/30 rounded">
                      <div className="text-[13px] font-bold text-secondary">{totalVendas.toLocaleString()}</div>
                      <div className="text-[9px] text-muted-foreground">Vendas</div>
                    </div>
                    <div className="text-center p-1.5 bg-muted/30 rounded">
                      <div className="text-[13px] font-bold" style={{ color: totalVendas >= totalReservas * 0.8 ? 'hsl(122, 39%, 49%)' : 'hsl(0, 72%, 51%)' }}>

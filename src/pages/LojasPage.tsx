                  ...
                  <table className="w-full text-sm">
                    <thead className="sticky top-0 bg-card">
                      <tr className="text-muted-foreground border-b">
                        ...
                        <th className="text-right py-1">Recomend.</th>
                    ...
                    <tbody>
                      {clientesData.map((cliente, idx) => (
                        <tr key={idx} className="border-b border-muted/30">
                          ...
                          <td className="py-1 text-right text-amber-500">{Math.floor(cliente.reservas * 0.18).toLocaleString()}</td>
                      ...
                      return (
                        <div key={idx} className="bg-muted/30 rounded p-1.5">
                          ...
                          <div className="grid grid-cols-4 gap-1 text-center mt-1">
                            ...
                            <div>
                              <div className="text-xs text-muted-foreground">Recomend.</div>
                              <div className="font-semibold text-sm text-amber-500">{Math.floor(cliente.reservas * 0.18).toLocaleString()}</div>
                            </div>
                            <div>

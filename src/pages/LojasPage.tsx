          ...
          <div className="grid grid-cols-12 gap-2 h-full">
            ...
            <div className="col-span-2 flex flex-col gap-2 h-full">
              <div className="grid grid-cols-2 gap-1.5 flex-1">
                <div className="bg-card rounded-lg border p-2.5 flex flex-col justify-center">
              ...
              {/* Inventário por Tipo */}
              <div className="bg-card rounded-xl border p-2 h-[140px] flex flex-col">
                  ...
                  <table className="w-full text-sm">
                    <thead className="sticky top-0 bg-card">
                      <tr className="text-muted-foreground border-b">
                        <th className="text-left py-1 w-[45%]">Cliente</th>
                        <th className="text-right py-1 w-[18%]">Reservas</th>
                        <th className="text-right py-1 w-[18%]">Vendas</th>
                        <th className="text-right py-1 w-[12%]">Taxa</th>
                      </tr>
                    </thead>
                    <tbody>
